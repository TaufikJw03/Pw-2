            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="gender" id="JenKel_0" type="radio" required="required" class="custom-control-input" value="Laki-Laki">
                        <label for="JenKel_0" class="custom-control-label">Laki-Laki</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input name="gender" id="JenKel_1" type="radio" required="required" class="custom-control-input" value="Perempuan">
